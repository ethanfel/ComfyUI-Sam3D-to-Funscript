...
from .processing_nodes import S3F_ProcessingTimeline, S3F_FolderTimeline, S3F_H3ProjectTimeline

NODE_CLASS_MAPPINGS = {cls.__name__: cls for cls in (S3F_VideoPose, S3F_ReferenceStabilize, S3F_ProcessingTimeline, S3F_FolderTimeline, S3F_H3ProjectTimeline, S3F_LoadPoseCache, S3F_CorePoseAdapter, S3F_AnchorOverride, S3F_BuildMotion, S3F_LoadProject, S3F_PreviewExport, S3F_StandaloneExport, S3F_CompareReference)}
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "S3F_H3ProjectTimeline": "H3 Animator · Funscript Workspace",
}
