...
def standalone_html(project=None):
    ...
    script = re.sub(r'import \{([^}]+)\} from "\./(curve\.mjs|curve-edit\.mjs|timeline\.mjs|viewport\.mjs|editor-session\.mjs|device-output\.mjs|video-preview\.mjs|device-previews/device-wireframes\.mjs)";',
