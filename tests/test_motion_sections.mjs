...
import {motionSections, sectionAt, trackLabel, processingTrackState, recreatedTrackChoices, sourceChoices} from '../assets/timeline.mjs';
...
assert.equal(processingTrackState(replaced,replaced.timeline.tracks[0]),'Saved detection');
assert.equal(processingTrackState(replaced,replaced.timeline.tracks[1]),'Current detection');
